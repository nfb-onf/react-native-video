...
public class ReactExoplayerViewManager extends ViewGroupManager<ReactExoplayerView> {
    ...
    private static final String PROP_TOGGLE_CONTROLS = "toggleControls";
    ...
    @ReactProp(name = PROP_TOGGLE_CONTROLS, defaultBoolean = false)
    public void setToggleControls(final ReactExoplayerView videoView, final boolean visibility) {
